...
- (void)scan: (CDVInvokedUrlCommand*)command;
{
    ...
    if(self.scanInProgress) {
      ...
      //  [infoButton addTarget: action:@selector(buttonPressed) forControlEvents:UIControlEventTouchUpInside];
        ...
        UIBarButtonItem *buttonFlash = [[UIBarButtonItem alloc] initWithTitle:@"双击打开闪光灯" style:UIBarButtonItemStyleDone target:self action:@selector(toggleflash)];
